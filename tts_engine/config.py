...
# List of folders to clean up .wav files from
CLEANUP_FOLDERS = [OUTPUT_DIR] # Add other temp folders if needed
...
KEEP_RECENT = 2 # Number of recent user/assistant message pairs to keep when summarizing
...
# ==============================================================================
# --- Reference Audio for Processing ---
# Used for pitch/F0 reference in audio_processing.py
REF_AUDIO_CLIP_PATH = CACHE_DIR / "alright_i_hear_you_pending_cache.wav"
REFERENCE_F0 = 0.0 # Set to 0.0 to disable F0 matching, otherwise calculated from REF_AUDIO_CLIP_PATH

# --- Audio Playback & Processing Parameters ---
CROSSFADE_MS = 80
CHUNK_MS = 20 # Used by audio player for buffer size
SILENCE_THRES_DB = -50
FADE_IN_MS = 100
TARGET_LUFS = -27.2
SAFE_PAUSE_MS = 250
